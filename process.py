...
\tIf no model is specified, sequence is used by default.
		...
		# Randomization testing of the null hypothesis that the observed 14C dates represent a random sample generated by a single event
		
		cal_ages, dists, summed, dists_rnd, sums_rnd, p = get_randomized(dates, curve)
		...
		pyplot.annotate("p: %0.5f\n%s" % (p, single_event_txt), xy = (0.05, 0.95), xycoords = "axes fraction", fontsize = 12, horizontalalignment = "left", verticalalignment = "top")
		pyplot.legend()
		pyplot.tight_layout()
		...
		clusters, means, ps, sils = get_clusters_hca(dates, curve)
